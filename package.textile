...
<pre class="terminal"><code>$ jark package search -p base64
...
<pre class="terminal"><code>$ jark package install --package compojure</code></pre>
...
<pre class="terminal"><code>$ jark package install -p clj-base64
...
<pre class="terminal"><code>$ jark package deps --package PACKAGE [--version]</code></pre>

To find the latest version of a package:
<pre class="terminal"><code>$ jark package latest --package PACKAGE
=> VERSION</code></pre>

To list all the packages that are installed:
<pre class="terminal"><code>$ jark package installed 
