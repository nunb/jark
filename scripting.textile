...
Currently, the scripts have to be run only on the server. Future versions of jark will support running scripts securely from a client. Let us see an example of writing a script with command-line args.
